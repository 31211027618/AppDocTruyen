package com.example.doancuoiky_appdoctruyen.LichSuTruyen.favBook;
...
import com.example.doancuoiky_appdoctruyen.DanhMucTruyen;
...
public class FavFolderFragment extends Fragment {
    ...
    private void Xoa(String idcanxoa){
        ...
        alterDialog.setMessage("Bạn có muốn xóa thư mục không ?");
